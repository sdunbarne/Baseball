...
What is the baseball statistic known as OPS\@?  How is this statistic
used?
...
\begin{enumerate}
    \item
        The key new statistic is how many runs will a team score if it
        uses this player for every plate appearance, called \defn{Markov
        runs}.
    \item
...
\begin{enumerate}
    ...
    \item
        ...
        on first and second one base.  This is not assumed here.
\end{enumerate}
...
or both.  The intent here is to show how to model baseball as a Markov
chain, in the process creating a new player evaluation statistic.
...
The key new statistic is how many runs will a team score by using this
player for every plate appearance.  This new statistic is called \defn{Markov
runs}.%
\index{Markov runs}
Cover and Keilers
...
for each batter.  Then the assumption of stationarity is dropped and the
